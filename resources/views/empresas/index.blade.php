                    ...
                    <div class="card mb-4">
                        <div class="card-body">
                            <form class="row g-2 align-items-end">
                                ...
                                <div class="col-md-8">
                                    <input type="text" id="texto" name="texto" class="form-control" placeholder="Nome, e-mail ou CNPJ" required>
                                </div>
                            ...
                            <tbody>
                                ...
                                @else
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('empresas.edit', $empresa) }}" class="btn btn-sm btn-primary">Editar</a>
                                            <button onclick="confirmDelete({{ $empresa->id }})" class="btn btn-sm btn-danger">Excluir</button>
                                            <form id="delete-form-{{ $empresa->id }}" action="{{ route('empresas.destroy', $empresa) }}" method="POST" class="d-none">
                                                @csrf
                                                @method('DELETE')
                                            </form>
                                        </td>
