        ...
        <div class="container-xl">
            <div class="row g-2 align-items-center">
                ...
                <div class="col-auto ms-auto d-print-none">
                    <div class="btn-list">
                        <a href="{{ route('empresas.create') }}" class="btn btn-dark btn-5 px-0 px-sm-3">
                            ...
                            <span class="d-none d-sm-flex">Cadastrar empresas</span>
                        </a>
                    ...
                    <div class="card mb-4">
                        <div class="card-body">
                            <form class="row g-2 align-items-end">
                                ...
                                <div class="col-md-8">
                                    <input type="text" id="texto" name="texto" class="form-control" placeholder="Nome, e-mail ou CNPJ" value="{{ request('texto') }}">
                                </div>
                                ...
                                <div class="col-md-2 d-flex gap-2">
                                    ...
                                    <a href="{{ route('empresas.index') }}" class="btn btn-light px-3">
                                        Limpar
                                    </a>
                                </div>
                    ...
                    <div class="card">
                            ...
                            <tbody>
                                ...
                                @else
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('empresas.details', $empresa) }}" class="btn btn-outline btn-secondary me-2">
                                            ...
                                            <a href="{{ route('empresas.edit', $empresa) }}" class="btn btn-outline btn-dark me-5">
                                            ...
                                            @if ($empresa->status === 1)
                                                <a href="{{ route('empresas.disable', $empresa) }}">
                                            ...
                                            @else
                                                <a href="{{ route('empresas.enable', $empresa) }}">
                        ...
                        <div class="card-footer d-flex align-items-center">
                            <p class="m-0 text-secondary">
                                Exibindo
                                <span id="end-entry">{{ $empresas->lastItem() ?? 0 }}</span>
                                de
                                <span id="total-entry">{{ $empresas->total() }}</span>
                                registros
                            </p>
                            <ul class="pagination m-0 ms-auto" id="pagination-custom">
                                {{-- Botão Anterior --}}
                                <li class="page-item {{ $empresas->onFirstPage() ? 'disabled' : '' }}" id="prev-page">
                                    <a class="page-link"
                                        href="{{ $empresas->onFirstPage() ? 'javascript:void(0);' : $empresas->previousPageUrl() }}"
                                        tabindex="-1"
                                        aria-disabled="{{ $empresas->onFirstPage() ? 'true' : 'false' }}">
                                ...
                                {{-- Botão Próximo --}}
                                <li class="page-item {{ $empresas->hasMorePages() ? '' : 'disabled' }}" id="next-page">
                                    <a class="page-link"
                                        href="{{ $empresas->hasMorePages() ? $empresas->nextPageUrl() : 'javascript:void(0);' }}">
                                        próximo
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
