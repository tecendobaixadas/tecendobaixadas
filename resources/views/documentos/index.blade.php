        ...
        <div class="container-xl">
            <div class="row g-2 align-items-center">
                ...
                <div class="col-auto ms-auto d-print-none">
                    <div class="btn-list">
                        <a href="{{ route('documentos.create') }}" class="btn btn-dark btn-5 px-0 px-sm-3">
                            ...
                            <span class="d-none d-sm-flex">Cadastrar documento</span>
                        </a>
                    ...
                    <div class="card">
                                ...
                                @else
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ route('documentos.edit', $documento) }}" class="btn btn-outline btn-dark me-5">
                        ...
                        <div class="card-footer d-flex align-items-center">
                            <p class="m-0 text-secondary">
                                Exibindo
                                <span id="end-entry">{{ $documentos->lastItem() ?? 0 }}</span>
                                de
                                <span id="total-entry">{{ $documentos->total() }}</span>
                                registros
                            </p>
                            <ul class="pagination m-0 ms-auto" id="pagination-custom">
                                {{-- Botão Anterior --}}
                                <li class="page-item {{ $documentos->onFirstPage() ? 'disabled' : '' }}" id="prev-page">
                                    <a class="page-link"
                                        href="{{ $documentos->onFirstPage() ? 'javascript:void(0);' : $documentos->previousPageUrl() }}"
                                        tabindex="-1"
                                        aria-disabled="{{ $documentos->onFirstPage() ? 'true' : 'false' }}">
                                ...
                                {{-- Botão Próximo --}}
                                <li class="page-item {{ $documentos->hasMorePages() ? '' : 'disabled' }}" id="next-page">
                                    <a class="page-link"
                                        href="{{ $documentos->hasMorePages() ? $documentos->nextPageUrl() : 'javascript:void(0);' }}">
                                        próximo
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
