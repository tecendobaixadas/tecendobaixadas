        ...
        <div class="container-xl">
            <div class="row row-cards">
                <div class="col">
                    <div class="card">
                        <div class="card-body">
                            <form method="POST" action="{{ isset($documento) ? route('documentos.update', $documento) : route('documentos.store') }}">
                                @csrf
                                @if(isset($documento))
                                    @method('PUT')
                                @endif
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-3 mb-3">
                                        ...
                                        <input type="text" id="data_emissao" name="data_emissao" class="form-control" value="{{ old('data_emissao', $documento->data_emissao ?? '') }}" required>
                                    </div>
