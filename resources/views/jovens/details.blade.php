                            ...
                            <form method="POST" action="{{ isset($jovem) ? route('jovens.update', $jovem) : route('jovens.store') }}" id="form" enctype="multipart/form-data">
                                ...
                                <div class="row mb-3">
                                    <div class="col d-flex justify-content-center">
                                        ...
                                        <div class="text-center">
                                            <label for="imagem_perfil" class="text-center d-block">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-3 mb-3">
                                        ...
                                        <input type="file" id="portfolio" name="portfolio" class="form-control" value="{{ old('portfolio', $jovem->portfolio ?? '') }}" accept=".pdf,.doc,.docx,.png,.jpg,.jpeg" required>
