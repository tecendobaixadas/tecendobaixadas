            ...
            <div class="card-body">
                <form class="row g-2 align-items-end">
                    ...
                    <div class="col-md-2 d-flex gap-2">
                        ...
                        <a href="{{ route('oportunidades.detalhes') }}" class="btn btn-light px-3">
                            Limpar
                        </a>
                    </div>
            ...
            <table class="table table-hover table-vcenter mb-0">
                <thead>
                    <tr>
                        ...
                        <th class="text-nowrap text-black text-center py-3">Candidatos</th>
                    ...
                    @else
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="{{ route('oportunidades.edit', $oportunidade) }}" class="btn btn-outline btn-dark me-5">
