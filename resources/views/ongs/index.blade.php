        ...
        <div class="container-xl">
            <div class="row g-2 align-items-center">
                ...
                <div class="col-auto ms-auto d-print-none">
                    <div class="btn-list">
                        <a href="{{ route('ongs.create') }}" class="btn btn-dark btn-5 px-0 px-sm-3">
                            ...
                            <span class="d-none d-sm-flex">Cadastrar ongs</span>
                        </a>
                        ...
                        <div class="card-body">
                            <form class="row g-2 align-items-end">
                                ...
                                <div class="col-md-2 d-flex gap-2">
                                    ...
                                    <a href="{{ route('ongs.index') }}" class="btn btn-light px-3">
                                        Limpar
                                    </a>
                                </div>
                    ...
                    <div class="card">
                        <table class="table table-hover table-vcenter mb-0">
                            ...
                            <tbody>
                                ...
                                @else
                                    @foreach($ongs as $ong)
                                    <tr>
                                        <td>{{ $ong->nome_organizacao }}</td>
                                        <td>{{ $ong->nome_organizacao }}</td>
                                        <td>{{ $ong->email_principal }}</td>
                                        <td>{{ $ong->cnpj ?? "--" }}</td>
                                        ...
                                        <td>
                                            <a href="{{ route('ongs.details', $ong) }}" class="btn btn-outline btn-secondary me-2">
                                            ...
                                            <a href="{{ route('ongs.edit', $ong) }}" class="btn btn-outline btn-dark me-8">
                        ...
                        <div class="card-footer d-flex align-items-center">
                            <p class="m-0 text-secondary">
                                Exibindo
                                <span id="end-entry">{{ $ongs->lastItem() ?? 0 }}</span>
                                de
                                <span id="total-entry">{{ $ongs->total() }}</span>
                                registros
                            </p>
                            <ul class="pagination m-0 ms-auto" id="pagination-custom">
                                {{-- Botão Anterior --}}
                                <li class="page-item {{ $ongs->onFirstPage() ? 'disabled' : '' }}" id="prev-page">
                                    <a class="page-link"
                                        href="{{ $ongs->onFirstPage() ? 'javascript:void(0);' : $ongs->previousPageUrl() }}"
                                        tabindex="-1"
                                        aria-disabled="{{ $ongs->onFirstPage() ? 'true' : 'false' }}">
                                ...
                                {{-- Botão Próximo --}}
                                <li class="page-item {{ $ongs->hasMorePages() ? '' : 'disabled' }}" id="next-page">
                                    <a class="page-link"
                                        href="{{ $ongs->hasMorePages() ? $ongs->nextPageUrl() : 'javascript:void(0);' }}">
                                        próximo
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
