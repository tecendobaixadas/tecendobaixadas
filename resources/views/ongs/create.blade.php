        ...
        <div class="container-xl">
            <div class="row row-cards">
                <div class="col">
                    <div class="card">
                        <div class="card-body">
                            <form method="POST" action="{{ isset($ong) ? route('ongs.update', $ong) : route('ongs.store') }}">
                                @csrf
                                @if(isset($ong))
                                    @method('PUT')
                                @endif
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-3 mb-3">
                                        ...
                                        <input type="text" id="cnpj" name="cnpj" class="form-control" value="{{ old('cnpj', $ong->cnpj ?? '') }}">
                                    </div>
                                    ...
                                    <div class="col-md-3 mb-3">
                                        ...
                                        <input type="date" id="data_fundacao" name="data_fundacao" class="form-control" value="{{ old('data_fundacao', $ong->data_fundacao ?? '') }}">
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3 mb-3">
                                        ...
                                        <input type="text" id="cep" name="cep" class="form-control" value="{{ old('cep', $ong->cep ?? '') }}" required>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-3 mb-3">
                                        ...
                                        <input type="text" id="telefone_fixo" name="telefone_fixo" class="form-control" value="{{ old('telefone_fixo', $ong->telefone_fixo ?? '') }}" required>
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3 mb-3">
                                        ...
                                        <input type="text" id="cpf_responsavel" name="cpf_responsavel" class="form-control" value="{{ old('cpf_responsavel', $ong->cpf_responsavel ?? '') }}" required>
                                    </div>
